...
const getAllImages = async (req, res) => {
  try {
    const allImages = await RoomImagesModel.findAll({
      include:[
        {
          model: db.RoomsModel
        }
...
export { getImage, deleteImage, editImage, addImage, displayImagesByRoom , getAllImages};
